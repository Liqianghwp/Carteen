 ...
 * @author ruoyi
 */
@Api(value = "/dict/opinion_type", tags = {"意见类型设置"})
@RestController
@RequestMapping("/dict/opinion_type")
public class DictOpinionTypeController extends BaseController {
    @Resource
    ...
    @PreAuthorize("@ss.hasPermi('dict:opinion:list')")
    @GetMapping
    ...
    @PreAuthorize("@ss.hasPermi('dict:opinion:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('dict:opinion:query')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:opinion:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:opinion:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:opinion:remove')")
    ...
    private void resetSysDictData(SysDictData sysDictData) {
        ...
        if (StringUtils.isBlank(sysDictData.getDictType())) {
            sysDictData.setDictType(SysConstants.OPINION_TYPE);
        }
    }
}
