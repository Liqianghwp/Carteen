 ...
 * @author ruoyi
 */
@Api(value = "/dict/raw_material_category", tags = {"原材料类别设置"})
@RestController
@RequestMapping("/dict/raw_material_category")
public class DictRawMaterialCategoryController extends BaseController {
    @Resource
    ...
    private void resetSysDictData(SysDictData sysDictData) {
        ...
        if (StringUtils.isBlank(sysDictData.getDictType())) {
            sysDictData.setDictType(SysConstants.RAW_MATERIAL_CATEGORY);
        }
    }
}
