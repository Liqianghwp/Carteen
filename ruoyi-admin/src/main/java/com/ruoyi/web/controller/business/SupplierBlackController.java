...
@Validated
@RestController
@Api(value = "/supplier_black", tags = {"供应商黑名单管理模块"})
@RequestMapping(value = "/supplier_black")
public class SupplierBlackController extends BaseController {
    ...
    @ApiOperation(value = "供应商管理分页查询 黑名单", notes = "供应商管理分页查询方法", httpMethod = "GET")
    @GetMapping()
    ...
    @ApiOperation(value = "移出黑名单", notes = "移出黑名单", httpMethod = "PUT")
