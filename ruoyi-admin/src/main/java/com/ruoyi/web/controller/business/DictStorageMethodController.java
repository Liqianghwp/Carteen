 ...
 * @author ruoyi
 */
@Api(value = "/dict/storage", tags = {"入库方式设置"})
@RestController
@RequestMapping("/dict/storage")
public class DictStorageMethodController extends BaseController {
    @Resource
    ...
    @PreAuthorize("@ss.hasPermi('dict:storage:list')")
    @GetMapping
    ...
    @PreAuthorize("@ss.hasPermi('dict:storage:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('dict:storage:query')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:storage:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:storage:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:storage:remove')")
    ...
    private void resetSysDictData(SysDictData sysDictData) {
        ...
        if (StringUtils.isBlank(sysDictData.getDictType())) {
            sysDictData.setDictType(SysConstants.STORAGE_METHOD);
        }
    }
}
