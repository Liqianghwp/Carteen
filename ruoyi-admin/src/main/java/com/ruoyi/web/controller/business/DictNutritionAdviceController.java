 ...
 * @author ruoyi
 */
@Api(value = "/dict/nutrition", tags = {"营养建议"})
@RestController
@RequestMapping("/dict/nutrition")
public class DictNutritionAdviceController extends BaseController {
    @Resource
    ...
    @PreAuthorize("@ss.hasPermi('dict:nutrition:list')")
    @GetMapping
    ...
    @PreAuthorize("@ss.hasPermi('dict:nutrition:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('dict:nutrition:query')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:nutrition:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:nutrition:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:nutrition:remove')")
    ...
    private void resetSysDictData(SysDictData sysDictData) {
        ...
        if (StringUtils.isBlank(sysDictData.getDictType())) {
            sysDictData.setDictType(SysConstants.NUTRITION_ADVICE);
        }
    }
}
