 ...
 * @author ruoyi
 */
@Api(value = "/dict/purchase", tags = {"采购类型设置"})
@RestController
@RequestMapping("/dict/purchase")
public class DictPurchaseTypeController extends BaseController {
    @Resource
    ...
    @PreAuthorize("@ss.hasPermi('dict:purchase:list')")
    @GetMapping
    ...
    @PreAuthorize("@ss.hasPermi('dict:purchase:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('dict:purchase:query')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:purchase:add')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:purchase:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('dict:purchase:remove')")
    ...
    private void resetSysDictData(SysDictData sysDictData) {
        ...
        if (StringUtils.isBlank(sysDictData.getDictType())) {
            sysDictData.setDictType(SysConstants.PURCHASE_TYPE);
        }
    }
}
