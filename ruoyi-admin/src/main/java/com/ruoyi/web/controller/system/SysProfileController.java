 ...
 * @author ruoyi
 */
@Api(value = "/system/user/profile", tags = {"个人信息 业务处理"})
@RestController
...
public class SysProfileController extends BaseController {
     ...
     * 个人信息
     */
    @ApiOperation(value = "个人信息", notes = "个人信息", httpMethod = "GET")
    @GetMapping
    ...
    public BaseResult updateProfile(@RequestBody SysUser user) {
        ...
        return BaseResult.error("修改个人信息异常，请联系管理员");
    }
     ...
     */
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", dataType = "string", name = "oldPassword", value = ""),
            @ApiImplicitParam(paramType = "query", dataType = "string", name = "newPassword", value = "")
    })
    ...
    @PostMapping("/avatar")
    public BaseResult avatar(@RequestParam("avatarfile") MultipartFile file) throws IOException {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
