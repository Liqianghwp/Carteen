...
@Data
@ApiModel("预留样品DTO实体类")
public class ReserveSampleGroupExportDTO implements Serializable {
     ...
     * 留样日期
     */
    @Excel(name = "留样日期", dateFormat = "yyyy-MM-dd HH:mm:ss", sort = 2)
    ...
    @Excel(name = "储存地点", sort = 6)
    @ApiModelProperty(value = "存储地点名称")
    private String storageLocationName;
    /**
     * 留样人
     */
    @Excel(name = "留样人", sort = 7)
